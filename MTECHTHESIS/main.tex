...
\centering
\vspace*{0.5cm}
{\Large\bfseries MULTIFIDUS MUSCLE CLASSIFICATION FROM ULTRASOUND IMAGING USING DEEP LEARNING\par}
\vspace{1.2cm}
{\bfseries A THESIS\par}
\vspace{0.2cm}
{\itshape Submitted by\par}
\vspace{0.4cm}
{\large\bfseries RAHUL BISHT\par}
\vspace{0.8cm}
{\itshape In partial fulfilment for the award of the degree of\par}
\vspace{0.4cm}
{\large\bfseries MASTER OF TECHNOLOGY\par}
{\bfseries IN\par}
{\bfseries COMPUTER SCIENCE AND ENGINEERING\par}
\vspace{0.8cm}
{\bfseries Under the guidance of\par}
\vspace{0.2cm}
{\bfseries Dr. Jayaraj PB\par}
\vfill
\IfFileExists{figures/nitclogo.pdf}{\includegraphics[width=0.22\textwidth]{figures/nitclogo.pdf}\par\vspace{0.4cm}}{}
{\bfseries DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING\par}
{\bfseries NATIONAL INSTITUTE OF TECHNOLOGY CALICUT\par}
{\bfseries KERALA, INDIA 673601\par}
\vspace{0.3cm}
{\bfseries 2026\par}
\end{titlepage}
...
\chapter*{Certificate}
This is to certify that the thesis entitled ``\textbf{Multifidus Muscle Classification from Ultrasound Imaging Using Deep Learning}'' submitted by \textbf{Rahul Bisht} to National Institute of Technology Calicut towards partial fulfillment of the requirements for the award of the Degree of Master of Technology in Computer Science and Engineering is a bonafide record of the work carried out under my supervision and guidance.

\vspace{2cm}
\noindent\textbf{Guide:} Dr. Jayaraj PB

\chapter*{Declaration}
I hereby declare that this submission is my own work and that, to the best of my knowledge and belief, it contains no material previously published or written by another person, nor material which has been accepted for the award of any other degree or diploma of any university or institute of higher learning, except where due acknowledgment has been made in the text.

\vspace{2cm}
\noindent\textbf{Name:} Rahul Bisht\\
\textbf{Reg. No.:} M241114CS
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.4\textwidth]{figures/yolo_finetune_pipeline.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.7\textwidth]{figures/datasetDistribution.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.9\textwidth]{figures/Architecture-of-the-YOLO-network.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.9\textwidth]{figures/yolo_arch.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.7\textwidth]{figures/EfficientNet-Architecture.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.9\textwidth]{figures/hierarchical-inf-pipe.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.9\textwidth]{figures/label-audit.png}
...
\label{workdone}
\section{Preliminary Classification and ROI Extraction}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.2\textwidth]{figures/bmode.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.2\textwidth]{figures/groundtruthmask.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.2\textwidth]{figures/predicted_mask.png}
...
\begin{figure}[H]
\centering
\safeincludegraphics[width=0.2\textwidth]{figures/roi_cut.jpg}
\caption{ROI crop}
\label{fig:roi}
\end{figure}

\section{ROI Extraction: Model Progression}
\subsection{SAM}
...
\subsection{YOLO-based ROI Extraction}
...
\section{Heckmatt Grade Classification}
...
\subsection{Earlier Backbone Experiments}
...
\subsection{Direct Four-Class Classification}
...
\section{Pairwise Binary Experiments}
...
\begin{figure}[H]
    \centering
    \safeincludegraphics[width=1\textwidth]{figures/heatmap_pairwise.png}
...
\begin{figure}[H]
    \centering
    \safeincludegraphics[width=1\textwidth]{figures/UI.jpg}
...
\begin{figure}[H]
    \centering
    \safeincludegraphics[width=1\textwidth]{figures/annotation.png}
...
\begin{figure}[H]
    \centering
    \safeincludegraphics[width=1\textwidth]{figures/loss.png}
...
\begin{figure}[H]
    \centering
    \safeincludegraphics[width=1\textwidth]{figures/accuracy.png}
