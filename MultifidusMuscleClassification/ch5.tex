...
\begin{figure}[H]
    \centering
    \safeincludegraphics[width=0.95\textwidth]{figures/heatmap_pairwise.png}
...
\begin{figure}[H]
    \centering
    \safeincludegraphics[width=0.95\textwidth]{figures/UI.jpg}
...
\begin{figure}[H]
    \centering
    \safeincludegraphics[width=0.95\textwidth]{figures/annotation.png}
